...
class ClientReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'client_name': forms.TextInput(attrs={'placeholder': 'Enter User Name', 'class': 'form-control'}),
            'review': forms.Textarea(attrs={'placeholder': 'Enter Review', 'class': 'form-control', 'rows': 4}),
        }
